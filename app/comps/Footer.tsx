  ...
  return (
    ...
    >
      ...
      <div className='flex flex-col laptop:flex-row laptop:justify-evenly justify-center items-center text-center'>
        <h4 className='absolute text-lg tablet:text-xl text-clr-white font-redHat font-black top-20 laptop:left-36 laptop:top-24 max-w-sm laptop:max-w-sm'>
          Experience more together
        </h4>
        <p className='absolute font-redHat text-clr-white top-52 px-6 max-w-xl laptop:max-w-xs laptop:top-28'>
          Stay connected with reliable HD meetings and unlimited one-on-one and
          group video sessions.
        </p>
        <button className='absolute text-sm font-redHat font-bold text-white bg-clr-purple px-7 py-4 rounded-full top-80 laptop:right-56 laptop:top-28 z-30 hover:bg-[#B18BDD] duration-200 '>
          Download{' '}
